 ...
 * Description:       DEPRECATED: Give [Mapster WP Maps](https://wordpress.org/plugins/mapster-wp-maps) a try for your Mapbox maps from now on!
 * Version:          	3.0.1
 * Author:            Mapster Tech
 ...
 */
define( 'WP_MAPBOX_GL_JS_VERSION', '3.0.1' );
